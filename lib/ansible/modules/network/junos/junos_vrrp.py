...
def main():
    ...
    param_to_xpath_map.update([
        ...
        ('ipv4', {'xpath': 'name', 'top': 'unit/family/inet/address', 'parent_attrib': False, 'is_key': True}),
        ('vrrp_group', {'xpath': 'vrrp-group/name', 'top': 'unit/family/inet/address'}),
        ('vip', {'xpath': 'virtual-address', 'top': 'unit/family/inet/address/vrrp-group'})
    ])
    ...
    for param in params:
        ...
        item = param.copy()
        if not item['vip']:
            module.fail_json(msg="one of the following is required: vip")
